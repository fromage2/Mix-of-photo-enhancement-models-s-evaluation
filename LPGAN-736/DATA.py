...
FLAGS['folder_input'] = './test/input/'
FLAGS['folder_processed_input'] = './test/processed_input/'
#FLAGS['folder_test_img']  = '../static/result/'
FLAGS['folder_results']  = './test/results/'
...
class DataFlow(object):
    def __init__(self):
        b = 1
        self.input1_src = tf.placeholder(tf.as_dtype(FLAGS['data_compute_dtype']), shape=[b, FLAGS['data_image_size'], FLAGS['data_image_size'], FLAGS['data_image_channel']])
        print self.input1_src
        self.input1 = tf.cast(self.input1_src, FLAGS['data_compute_dtype']) / 255
        print self.input1
